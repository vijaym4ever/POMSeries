...
import com.qa.opencart.utils.ExmsUtil;
...
public class RegisterPageTest extends BaseTest {
	...
	public String getRandomNumber() {
		...
		String email = "mylearningtestMarch"+randomGen.nextInt(1000)+"@gmail.com";
		return email;
	}
	...
	public Object[][] getRegData(){
		Object regData[][] = ExmsUtil.getTestData(Constants.REGISTER_SHEET_NAME);
		return regData;
	}
